...
public class QuadraticCostFunction extends AbstractCostFunction
{
  public QuadraticCostFunction(final String id, final List<Double> targetValues)
  {
    super(id, targetValues);
  }

  private double square(final double base)
  {
    return base * base;
  }
  ...
  public Double apply(final List<Perceptron> outputLayerPerceptrons) {
    ...
    for (int index = 0; index < size; index++) {
      ...
      cost += square(targetValues.get(index) - perceptron.getOutput());
    }
